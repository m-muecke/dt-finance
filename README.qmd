...
The goal of this document is to store common financial calculations using
the `data.table` package using the latest R and data.table syntax.
...
Or turn it into a wide-format and show display the performance as a line area chart:
